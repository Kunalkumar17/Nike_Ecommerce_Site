...
import { bin_icon } from '../assets/icons'
    ...
    <div>
        ...
        <div className='pt-14 mx-20'>
            <div className="flex gap-2 items-center">
                <h1 className="text-3xl max-sm:text-2xl justify-center flex font-serif"><span className='text-gray-500 pr-2'>YOUR</span>CART</h1>
                    ...
                    cartData.map((item,index) => {
                        ...
                        return (
                            <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                                ...
                                <img onClick={()=>updateQuantity(item._id,item.size,0)} className='w-4 mr-4 sm:w-5 cursor-pointer' src={bin_icon} alt="bin_icon" />
                            </div> 
                        )
                    })
                }
